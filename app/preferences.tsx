...
export default function Preferences() {
  ...
  return (
    <Screen>
      ...
      <View className="px-5">
        <Text className="mb-2 text-[13px] font-bold uppercase text-dime-ink-2" style={{ letterSpacing: 1.5 }}>Food preferences</Text>
        <ChipRow>
          {prefs.map((p) => (
      ...
      <View className="mt-5 px-5">
        <Text className="mb-2 text-[13px] font-bold uppercase text-dime-ink-2" style={{ letterSpacing: 1.5 }}>Allergens</Text>
        <ChipRow>
          {allergens.map((a) => (
