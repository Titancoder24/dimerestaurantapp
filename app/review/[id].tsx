...
export default function ReviewScreen() {
  ...
  return (
    <Screen>
      ...
      <View className="mx-5 items-center rounded-2xl bg-white p-6" style={{ shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 3 }}>
        <Text className="text-[13px] text-dime-ink-3">Overall</Text>
        <View className="mt-2">
          <StarRating value={overall} onChange={setOverall} size={36} />
        </View>
        <Text className="mt-2 text-[16px] font-bold text-dime-ink" style={{ letterSpacing: -0.5 }}>
      ...
      <View className="mx-5 mt-4 rounded-2xl bg-white p-4" style={{ shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 3 }}>
        <Text className="text-[13px] font-bold uppercase text-dime-ink-2" style={{ letterSpacing: 1.5 }}>Tell us more (optional)</Text>
        <TextInput
          multiline
          numberOfLines={4}
          ...
          className="mt-2 min-h-[100px] rounded-xl border border-neutral-50 bg-white p-3 text-[14px] text-dime-ink"
          textAlignVertical="top"
        />
      </View>

      <View className="mx-5 mt-4">
        <Text className="mb-2 text-[13px] font-bold uppercase text-dime-ink-2" style={{ letterSpacing: 1.5 }}>Would you recommend?</Text>
        <ChipRow>
