  ...
  return (
    <Screen>
          ...
          <View key={r.id} className="rounded-2xl bg-white p-4" style={{ shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 12, elevation: 2 }}>
            <View className="flex-row items-center gap-2">
              ...
              <View className="flex-1">
                <Text className="text-[14px] font-bold text-dime-ink">{r.users?.name ?? "Diner"}</Text>
            ...
            {r.reply_text ? (
              <View className="mt-2 rounded-xl bg-dime-bg-2 p-2">
                <Text className="text-[11px] font-bold uppercase text-dime-primary-700" style={{ letterSpacing: 1.5 }}>Your reply</Text>
              ...
              <View className="mt-2">
                <Pressable
                  ...
                  className="self-start rounded-full border border-neutral-50 px-3 py-1.5"
                >
                  <Text className="text-[12px] font-bold text-dime-primary-600">Reply</Text>
                </Pressable>
              </View>
            )}
          </View>
      ...
      <Sheet visible={!!reply} onClose={() => setReply(null)} maxHeight="60%">
        <Sheet.Body>
          <Text className="text-[15px] font-bold text-dime-ink">Reply to diner</Text>
          <TextInput
            value={text}
            ...
            className="mt-3 min-h-[120px] rounded-xl border border-neutral-50 bg-white p-3 text-[14px] text-dime-ink"
