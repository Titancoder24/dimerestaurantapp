...
export default function AdminBookings() {
  ...
  return (
    <Screen scroll={false}>
      ...
      <View className="px-4">
        <Input value={query} onChangeText={setQuery} placeholder="Customer, restaurant..." leading={<Icon name="magnifyingglass" size={16} color="#8E8E93" />} />
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text className="px-4 py-12 text-center text-[13px] text-dime-ink-3">No bookings match.</Text>}
      />
    </Screen>
  );
}
