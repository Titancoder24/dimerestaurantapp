...
export default function Risk() {
  ...
  return (
    <Screen scroll={false}>
      ...
      <View className="mx-4 mt-3 rounded-2xl border border-dime-border bg-white p-3">
        <Text className="text-[11px] font-bold uppercase tracking-widest text-dime-ink-3">Risk score formula</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View className="items-center py-12">
            ...
            <Text className="mt-2 text-[14px] font-semibold text-dime-ink">No risky accounts</Text>
          ...
          >
            <View className="flex-row items-center gap-3">
              ...
              <View className="items-end">
                <Text className={`text-[18px] font-bold ${item.risk_score >= 60 ? "text-dime-danger" : item.risk_score >= 30 ? "text-amber-700" : "text-emerald-700"}`}>{item.risk_score}</Text>
                <Text className="text-[10px] uppercase tracking-widest text-dime-ink-3">risk</Text>
              </View>
            </View>
